...
<div id="contenido">
    ...
    <?php } else { ?>
        ...
        <!-- <form action="index.php?ctl=modificarAlumno&id_alumno=<?php echo $params['id_alumno']; ?>" method="post" name="actualizarUsuario"> -->
                ...
                <div class="col-md-6">
                    ...
                    <select name="curso" id="curso" class="form-control">
                        <?php foreach ($params['cursos'] as $curso) { ?>
                            <option value="<?php echo $curso['id_curso']; ?>" <?php echo ($curso['id_curso'] == $params['curso']) ? 'selected' : ''; ?>>
