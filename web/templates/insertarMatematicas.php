...
<div id="contenido">
        ...
        <form ACTION="index.php?ctl=insertarMatematicas" METHOD="post">
        ...
        <div class="row mb-3">
                ...
                <div class="row mb-3 justify-content-center">
                    <div class="col-auto py-3">
                        <button type="submit" class="btn btn-secondary mx-3 px-3" name="bInsertarMatematicas">Aceptar</button>
